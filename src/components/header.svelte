<script>
  ...
  import YoutubeSvg from "@/components/svgs/youtube.svelte";
  ...
  <ul class="links" bind:this={linksEle}>
    ...
    <li class="heart" bind:this={heartEle} on:click|stopPropagation={showTT}>
      ...
      >
        ...
        <a
          href="https://www.youtube.com/watch?v=EOwjX1c37qw&ab_channel=ViewOverviewVlogs"
          target="_blank"
        >
          <YoutubeSvg />
          <span>{$_(`header.youtube`)}</span>
        </a>
        <div class="heart-tt-arrow" data-popper-arrow />
      </ul>
    </li>
  </ul>
